...
public:
  ...
  : msg_(msg)
  {}
  ::urc_msgs::msg::ArucoDetection id(::urc_msgs::msg::ArucoDetection::_id_type arg)
  {
...
class Init_ArucoDetection_z_angle
{
public:
  explicit Init_ArucoDetection_z_angle(::urc_msgs::msg::ArucoDetection & msg)
  : msg_(msg)
  {}
  Init_ArucoDetection_distance z_angle(::urc_msgs::msg::ArucoDetection::_z_angle_type arg)
  {
    msg_.z_angle = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_ArucoDetection_z_angle y_angle(::urc_msgs::msg::ArucoDetection::_y_angle_type arg)
  {
    msg_.y_angle = std::move(arg);
    return Init_ArucoDetection_z_angle(msg_);
  }
