...
static rosidl_typesupport_introspection_c__MessageMember urc_msgs__msg__ArucoLocation__rosidl_typesupport_introspection_c__ArucoLocation_message_member_array[4] = {
  {
    "header",  // name
